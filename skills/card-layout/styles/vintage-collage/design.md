...
> 三套对比:warm-editorial 暖克制 / folder-doodle 多色俏皮 / **本套近单色 + 纸纹 + 拼贴**。
...
纸纹 + 版画的木刻颗粒 = 全部艺术感来源。所以纹理**必须有**(和 warm-editorial / folder-doodle 相反)。除纸纹外别再加做旧滤镜。
...
不适合:信息密集的教程/清单/分类(那找 folder-doodle)、需要明快活泼的(那找 folder-doodle)。
